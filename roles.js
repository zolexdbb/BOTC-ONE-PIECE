const roles = [
  ...
  {name: "Imu", camp: "marine", title: "Souverin du monde", power: "Première nuit : choisi les marines qui seront à c'est coter (le nombre sera donner par le mj) mais ne peut choisir les joueur. Ensuite il peut tuer un joueur par nuit tout comme le sengoku.", explication:"Force centrale du Gouvernement. Nuit : élimine un joueur ciblé. Choisi les marines à c'est côter. Mort = Pirates gagnent (sauf si Akainu vivant).", img:"img/perso/Marine/Imu.png"},
  ...
  {name: "Robin", camp: "pirate", title:"Chapeu de paille", power:"Première nuit : découvre deux joueurs et un rôle Révolutionnaire spécifique. L’un le possède, l’autre peut être n’importe qui.", explication:"Nuit 1 : obtient 2 joueurs et 1 rôle Révolutionnaire.", img:"img/perso/Pirate/robin.png"},
  {name: "Brook", camp: "pirate", title:"Chapeu de paille", power:"Si Brook meurt, se réveille une seule fois pour connaître le rôle d’un joueur (mort ou vivant) de son choix.", explication:"Nuit post-mort : choisir un joueur et découvrir son rôle.", img:"img/perso/Pirate/brook.png"},
  {name: "Sanji", camp: "pirate", title:"Chapeu de paille", power:"Première nuit : apprend le nombre de paires de Marines côte à côte autour de la table.", explication:"Nuit 1 : obtient l'information sur le nombre de paires de Marine.", img:"img/perso/Pirate/sanji.png"},
  {name: "Chopper", camp: "pirate", title:"Chapeu de paille", power:"Chaque nuit : découvre le nombre de Marines adjacents à lui (0,1,2), morts exclu.", explication:"Nuit : obtient l'info du nombre de marines a proximité de lui.", img:"img/perso/Pirate/chopper.png"},
  ...
  {name: "Nami", camp: "pirate", title:"Chapeu de paille", power:"Première nuit : découvre deux joueurs et un rôle Pirate spécifique. L’un le possède, l’autre peut être n’importe qui.", explication:"Nuit 1 : obtient 2 joueurs et 1 rôle Pirate.", img:"img/perso/Pirate/nami.png"},
  {name: "Luffy", camp: "pirate", title:"Chapeu de paille", power:"Si ciblé par Sengoku : un autre joueur peut mourir à sa place (choix du MJ).", explication:"Nuit : peux ne pa mourir si attaqué par l'Amiral en chef mais un autre joueur aléatoire meurt.", img:"img/perso/Pirate/luffy.png"},
  ...
  {name: "Zoro", camp: "pirate", title:"Chapeu de paille", power:"Une fois par partie, durant le conseil, peut désigner publiquement une cible : si c’est l’Amiral en chef → il meurt.", explication:"Action de jour → désigne un jouer qu'il veut éliminer à la vue de tous.", img:"img/perso/Pirate/zoro.png"},
  ...
  {name: "Bon Clay", camp: "pirate", title:"Pirate", power:"Durant la nuit : eut choisir un rôle pirate : il copie les pouvoirs du rôle choisi, mais si ce rôle est déjà présent dans la partie, l’utilisateur original devient empoisonné pour le reste de la partie.", explication:"Nuit : Copie le pouvoir d'un pirates, si présent le joueur originel de vient empoisonner.", img:"img/perso/Pirate/bonclay.png"},
